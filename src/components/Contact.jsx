...
const About = () => {
  ...
  {/* <p className='left_box'>
    <h1>insanexmedia.com (CONTACT)</h1>
    <p className='domain'>Your domain is expired. Renew the domain to <br></br>activate the website</p>
    <p className='website'>Website content is unavailable due to the fact that domain has expired. Renew your domain in order to see your website online.</p>
    <p style={{color:'rgb(39, 39, 75)', fontSize:'2.5rem', fontWeight:'bold'}}>What's next?</p>
    <div className='box_About_display'>
      <p className='width_About'>
        <p style={{color:'rgb(39,39,75',fontSize:'25px', fontWeight:'bold'}}>Save Your Domain</p>
        <p style={{color:'gray', fontSize:'26px'}}>Don't lose your domain.Log  in to your Hostineger account in order to renew your domain</p>
  ...
  <div className='left_box'>
            ...
            <p className='website' data-aos="fade-right" data-aos-delay="600">Website content is unavailable due to the fact that domain has expired. Renew your domain in order<br/> to see your website online.</p>
            <p style={{color:'rgb(39, 39, 75)', fontSize:'2.5rem', fontWeight:'bold'}}>What's next?</p>
